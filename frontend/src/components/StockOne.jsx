            ...
            <div className='h-full space-y-6 w-full'>
                <div className=' flex items-center justify-start '>
                    <div className=' gap-6 flex items-center justify-center'>
                        ...
                        <div className='flex items-center justify-center'>
                            <h1 className='font-bold text-[16px]' >{stockName}</h1>
                        </div>
                    </div>
                </div>
                <div className='flex items-center justify-between'>
                    <div>
                        <div className=' text-[#747474] text-[14px] flex items-center justify-center'>
                            Quantity
                        </div>
                        <div className='flex items-center justify-center '>
                    ...
                    <div>
                        ...
                        <div className='flex items-center justify-center '>
                            <h1 className='font-bold'>{amountUsed}</h1>
                        </div>
                    </div>
                </div>
